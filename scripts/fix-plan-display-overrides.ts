...
(async () => {
  ...
  if (planPrices.TUTOR_BASIC) {
    planPrices.TUTOR_BASIC = {
      ...
      name: "Tutor Pro",
      description:
        "Relevance-first ranking, unlimited enquiry reveals, and up to 10 active Teaching Profiles. Free tutors keep 1 Teaching Profile with organic search visibility.",
      promoNote:
