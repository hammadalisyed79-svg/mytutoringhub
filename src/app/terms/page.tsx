    ...
    <div className="page">
      <div className="container narrow-prose">
        ...
        <div className="legal-body">
          <h2>1. About MyTutoringHub</h2>
          <p>
            MyTutoringHub is a marketplace that connects students and private tutors. We do not
          ...
          <h2>2. Accounts</h2>
          <p>
            You must provide accurate registration details and keep your password secure. You are
          ...
          <h2>6. Liability</h2>
          <p>
            Lessons and payments between users are outside our control. MyTutoringHub is provided
