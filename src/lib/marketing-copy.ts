...
export const TUTOR_FREE_LISTING_LINE =
  "Complete your profile to appear in search for free. Free tutors get up to 3 active Teaching Profiles, enquiries, and 100% of lesson fees — no subscription required for ordinary search visibility. Tutor Pro unlocks up to 10 Teaching Profiles plus growth tools.";
