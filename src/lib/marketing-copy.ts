...
export const TUTOR_FREE_LISTING_LINE =
  "Complete your profile to appear in search for free. Free tutors get up to 3 active Teaching Profiles for different subjects, enquiries, and 100% of lesson fees — no subscription required for ordinary search visibility. Tutor Pro unlocks up to 10 Teaching Profiles plus growth tools.";

export const TUTOR_PRO_LISTING_LINE =
  "Tutor Pro includes up to 10 active Teaching Profiles, relevance-first ranking enhancement, unlimited enquiry reveals, enhanced student-request access, and analytics.";
