...
export const TUTOR_FREE_LISTING_LINE =
  `Complete your profile to appear in search for free. Free tutors get ${BUSINESS.tutorFreeActiveListings} live Teaching Profile, enquiries, and 100% of lesson fees. Extra Active adds more live subjects (up to 3). Tutor Pro unlocks up to ${BUSINESS.tutorProActiveListings} plus growth tools.`;
